...
class SRAMDataTest(unittest.TestCase):
    def test_checked_in_t7_and_f7_records(self):
        ...
        self.assertAlmostEqual(t7.static_power_mw, 0.063735)
        self.assertAlmostEqual(t7.area_um2, 23249.16)
        self.assertEqual(t7.static_power_scale, 1.0)
        self.assertEqual(t7.area_scale, 1.0)
        self.assertEqual(f7.derived_from, t7.record_id)
        self.assertEqual(f7.static_power_scale, 0.5)
        self.assertEqual(f7.area_scale, 0.5)
        self.assertAlmostEqual(f7.static_power_w, t7.static_power_w * 0.5)

...
print(f"VPU_ELEMWISE_EXIT_CAUSE={exit_cause}")
print(f"VPU_ELEMWISE_EXIT_CODE={exit_code}")
print(f"VPU_ELEMWISE_COMPLETED_CMDS={vpu['completed']}")
print(f"VPU_ELEMWISE_PROLOGUES={vpu['prologues']}")
print(f"VPU_ELEMWISE_READ_RESPS={vpu['read_resps']}")
print(f"VPU_ELEMWISE_EXECUTES={vpu['executes']}")
print(f"VPU_ELEMWISE_WRITE_RESPS={vpu['write_resps']}")
print(f"VPU_ELEMWISE_EPILOGUES={vpu['epilogues']}")
print(f"VPU_ELEMWISE_ITERATIONS={vpu['iterations']}")

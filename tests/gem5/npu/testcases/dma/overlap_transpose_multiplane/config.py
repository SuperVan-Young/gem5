...
SCENARIO_NAME = "overlap_transpose_multiplane"
EXPECTED_SNAPSHOT = {
...
builder, process = build_dma_functional_system(binary, scenario=SCENARIO_NAME)
...
snapshot = {
    ...
    "overlap": system.dma.observedBatchOverlapCount(),
...
if snapshot["overlap"] < 1:
    print("DMA transpose overlap testcase requires observedBatchOverlapCount >= 1")
    raise SystemExit(1)

...
EXPECTED_RESULT = {
    ...
    "queue_occupancy": 0,
    "issue_busy": False,
    "completed_cmds": LOOP_COUNT,
    "prologues": LOOP_COUNT,
    "executes": LOOP_COUNT,
    "epilogues": LOOP_COUNT,
    "iterations": LOOP_COUNT,
    "read_resps": LOOP_COUNT,
    "write_resps": LOOP_COUNT,
}
...
for key, value in result.items():
    print(f"VPU_LAUNCH_COST_SMOKE_{key.upper()}={value}")

if verify_simulation_result(result):
    print("VPU_LAUNCH_COST_SMOKE_PASS")

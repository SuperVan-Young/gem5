...
print(f"VPU_LOADSTORE_EXIT_CAUSE={exit_cause}")
print(f"VPU_LOADSTORE_EXIT_CODE={exit_code}")
print(f"VPU_LOADSTORE_COMPLETED_CMDS={vpu['completed']}")
print(f"VPU_LOADSTORE_PROLOGUES={vpu['prologues']}")
print(f"VPU_LOADSTORE_READ_RESPS={vpu['read_resps']}")
print(f"VPU_LOADSTORE_EXECUTES={vpu['executes']}")
print(f"VPU_LOADSTORE_WRITE_RESPS={vpu['write_resps']}")
print(f"VPU_LOADSTORE_EPILOGUES={vpu['epilogues']}")
print(f"VPU_LOADSTORE_ITERATIONS={vpu['iterations']}")

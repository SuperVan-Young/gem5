...
print(f"VPU_FMA_EXIT_CAUSE={exit_cause}")
print(f"VPU_FMA_EXIT_CODE={exit_code}")
print(f"VPU_FMA_COMPLETED_CMDS={vpu['completed']}")
print(f"VPU_FMA_PROLOGUES={vpu['prologues']}")
print(f"VPU_FMA_READ_RESPS={vpu['read_resps']}")
print(f"VPU_FMA_EXECUTES={vpu['executes']}")
print(f"VPU_FMA_WRITE_RESPS={vpu['write_resps']}")
print(f"VPU_FMA_EPILOGUES={vpu['epilogues']}")
print(f"VPU_FMA_ITERATIONS={vpu['iterations']}")

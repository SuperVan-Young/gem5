...
class NPUTestSystemBuilder:
    ...
    def add_vpu(
        ...
        dlen_bytes=4,
        int8_cycles_per_dlen=1,
        int16_cycles_per_dlen=1,
        ...
        kwargs = {
            ...
            "int8_cycles_per_dlen": int8_cycles_per_dlen,
            "int16_cycles_per_dlen": int16_cycles_per_dlen,
            "int32_cycles_per_dlen": int32_cycles_per_dlen,
            "float16_cycles_per_dlen": float16_cycles_per_dlen,
            "float32_cycles_per_dlen": float32_cycles_per_dlen,
            "debug_process_latency": debug_process_latency,
            "sync_enqueue_on_data_write": sync_enqueue_on_data_write,
        }

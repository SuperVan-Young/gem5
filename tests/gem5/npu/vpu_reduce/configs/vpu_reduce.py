...
print(f"VPU_REDUCE_EXIT_CAUSE={exit_cause}")
print(f"VPU_REDUCE_EXIT_CODE={exit_code}")
print(f"VPU_REDUCE_COMPLETED_CMDS={vpu['completed']}")
print(f"VPU_REDUCE_PROLOGUES={vpu['prologues']}")
print(f"VPU_REDUCE_READ_RESPS={vpu['read_resps']}")
print(f"VPU_REDUCE_EXECUTES={vpu['executes']}")
print(f"VPU_REDUCE_WRITE_RESPS={vpu['write_resps']}")
print(f"VPU_REDUCE_EPILOGUES={vpu['epilogues']}")
print(f"VPU_REDUCE_ITERATIONS={vpu['iterations']}")
